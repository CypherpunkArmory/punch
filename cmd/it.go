...
var itCmd = &cobra.Command{
	...
	Long:  "Expose a web server on the ports you specify.\n" +
	       ...
	       "Example: `punch it http:8080 https:443 mydomain` will expose a web server running on port 8080 via \"http://mydomain.holepunch.io\"\n" +
	       "          and an https web server running on port 443 via \"https://mydomain.holepunch.io\".\n" +
